...
class EpubLoaderTest {
    ...
    void testPageCount() throws IOException{
        ...
        // actual page count is around 400, but it is usually lower
        // due to page slicer ignoring actual image size font style and formatting
        // If result page count is significantly off then something gone VERY wrong
        assertThat(loader.getPagesCount()).isGreaterThan(300);
        assertThat(loader.getPagesCount()).isLessThan(450);
    }
